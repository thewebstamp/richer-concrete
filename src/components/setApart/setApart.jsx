    ...
    return (
        <div className="set-apart-wrap">
            <div className="sa-top" ref={setApartT}>
                <div className="sa-headline">WHY CHOOSE RICHER CONCRETE LLC?</div>
                <h2>We are a Trusted Name in the Concrete Installation Space</h2>
            ...
            <div className="sa-base" ref={setApartB}>
                ...
                <img src={Images.heroImg4} className="sa-img" />
                <img src={Images.heroImg4} className="sa-img-height" />
            </div>
        </div>
    )
}
